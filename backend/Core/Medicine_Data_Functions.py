...
def get_or_create_medicine(db: Session, medicine_data : dict) -> Medicine:
    ...
    new_medicine = Medicine(**medicine_data)
    db.add(new_medicine)
    db.commit()
...
def medicine_by_id(db:Session, medicine_id: int) -> Medicine | None:
